...
UsersList[sensorId] - tracked users per sensor. https://github.com/3DiVi/nuitrack-sdk/blob/master/Unity3D/doc/Development.md#users
Floors[sensorId] - floor planes per sensor from UserFrame - https://download.3divi.com/Nuitrack/doc/classnuitrack_1_1UserFrame.html#a3ac5d1090492d8f2c98a3ef47d6b2c5b
...
4. Add this component to all Raw Images on scene. In the sensorSerialNumber field, specify the sensor serial number from which you want to receive data
